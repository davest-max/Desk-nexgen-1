...
export const closedStaticContacts: StaticAssignment[] = [
  ...
  },
  {
    ...
    priority: "Medium",
    status: "resolved",
    preview: "Statement discrepancy on January invoice — credit adjustment applied",
    waitTime: "",
    resolvedAt: "Jan 22, 2026",
    customerContext: "2-year client. First email inquiry. Polite and detail-oriented. Sentiment: Satisfied after explanation.",
    aiOverview: {
      actions: [
        "Sandra emailed billing support about a $180 discrepancy on her January statement.",
        "Agent reviewed the invoice and identified a misapplied promo code.",
        "Credit of $180 applied to the next billing cycle and confirmed by email.",
      ],
      whyNeeded: "Discrepancy resolved. Credit issued. No further action required.",
      nextSteps: ["Confirm credit appears on February statement"],
    },
  ...
  },
  {
    ...
    priority: "High",
    status: "resolved",
    preview: "Unable to log in after password reset — account access restored",
    waitTime: "",
    resolvedAt: "Nov 14, 2025",
    customerContext: "2-year client. Called in urgently — needed access for a board-level report. Sentiment: Stressed, relieved after resolution.",
    aiOverview: {
      actions: [
        "Sandra reported being locked out after a self-service password reset failed to deliver the reset email.",
        "Agent verified identity via security questions and account PIN.",
        "Manually triggered reset email from admin panel — access confirmed within 5 minutes.",
      ],
      whyNeeded: "Access restored. Root cause was a cached SSO token conflict.",
      nextSteps: ["Recommend Sandra clear browser cache before next password change"],
    },
  ...
  },
  {
    ...
    company: "Apex Financial Group",
    botType: "Compliance Bot",
    caseType: "Data Request",
    agentType: "virtual",
    channel: "email",
    priority: "Low",
    status: "resolved",
    preview: "Requested export of 12-month transaction history — delivered securely",
    waitTime: "",
    resolvedAt: "Sep 3, 2025",
    customerContext: "2-year client. Annual audit preparation. Routine request. Sentiment: Professional and appreciative.",
    aiOverview: {
      actions: [
        "Sandra requested a full 12-month transaction export for internal audit purposes.",
        "Agent generated the report in CSV and PDF formats.",
        "Secure download link sent and confirmed received.",
      ],
      whyNeeded: "Data export fulfilled. No compliance issues identified.",
      nextSteps: [],
    },

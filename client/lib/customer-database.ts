...
export const customerDatabase: CustomerSeedRecord[] = [
  ...
  },
  {
    ...
    customerHistory: [
      ...
      },
      {
        ...
        detail: "Completed annual plan review with Jeff Common. Roth IRA conversion strategy flagged for follow-up in Q2.",
        dot: "purple",
      },
      {
        id: "priya-h3",
  ...
  },
  {
    ...
    customerHistory: [
      ...
      { id: "hannah-h3", title: "Advisor assigned — Jeff Common", timestamp: "Jun 2022", detail: "Hannah was paired with Jeff Common following a review of her growing portfolio. Advisor relationship confirmed.", dot: "purple" },
  ...
  },
  {
    ...
    interactionTimeline: [
      ...
      },
      {
        ...
        detail: "Jacob escalated to Jeff Common for dispute authorization and immediate customer support.",
        tone: "critical",
        sortOrder: 5,
      },
    ],
    customerHistory: [
      ...
      },
      {
        id: "sofia-h10",
        type: "handoff",
        title: "Escalated to Jeff Common — fraud specialist",
        timestamp: "Today · 9:52 AM",
        detail: "Jacob escalated to Jeff Common (Fraud & Security Specialist) to authorize the dispute, apply provisional credit of $2,159.47, block card ****7714, and issue a replacement card. Rent deadline tomorrow adds critical urgency.",
        dot: "red",
        customerMessage: "I want to speak to someone who can actually FIX this right now.",
        meta: [
          { label: "Case #", value: "CST-12045" },
          { label: "Escalated to", value: "Jeff Common — Fraud & Security Specialist" },
        ...
        interaction: {
          ...
          notes: [
            ...
            { author: "System", time: "Today · 9:52 AM", isInternal: true, text: "Case CST-12045 assigned to Jeff Common (Fraud & Security Specialist). Priority: Critical. Customer is live in chat and awaiting response." },
          ],
        },
      },
    ],
 ...
 author: "Jacob", content: "Hi Sofia — I've reviewed both transactions and they've been flagged as suspicious. I'm escalating this to our fraud team now.", time: "9:47 AM" },
    ...
    customerHistory: [
      ...
      },
      {
        ...
        meta: [
          ...
          { label: "Escalated to", value: "Jeff Common" },
        ...
        interaction: {
          ...
          notes: [
            ...
            { author: "System", time: "Today · 9:44 AM", isInternal: true, text: "Case CST-11621 created and assigned to Jeff Common (Tier 2 — Network Specialist). Priority: Critical. Customer is live and waiting. Do not proceed with factory reset without agent confirmation." },
          ],
        },
      },
    ],
  ...
  },
  {
    ...
    customerHistory: [
      ...
      },
      {
        id: "marcus-h10",
        type: "handoff",
        title: "Escalated to Jeff Common — time-sensitive",
        timestamp: "Today · 10:14 AM",
        detail: "Emily escalated to Jeff Common (Senior Care). Resolution paths: reship overnight to Austin, full refund + reorder, or carrier intercept attempt. Birthday deadline Saturday — goodwill gesture recommended.",
        dot: "red",
        customerMessage: "I need a real person.",
        meta: [
          { label: "Case #", value: "CST-13317" },
          { label: "Escalated to", value: "Jeff Common — Senior Care" },
  ...
  },
  {
    ...
    profile: {
      ...
      financialAdvisor: "",
      advisorTitle: "",
      tags: ["Active", "Billing Dispute", "Transferred"],
      fraudRiskScore: 0,
      priorDisputeCount: 0,
      cardBlocked: false,
    },
    conversationTopics: [
      "Charged $147 for Pro subscription cancelled December 10",
      "Cancellation confirmation email on file",
      "Two prior agents unable to process refund due to billing system errors",
    ],
    contact: {
      email: "diana.chen@email.com",
      phone: "(628) 555-0213",
      address: { street: "520 Clay St", city: "San Francisco", state: "CA", zip: "94111", country: "US" },
    },
    accounts: [
      { id: "dc-sub", type: "Business", number: "CST-15872", balance: "", availableBalance: "", status: "active", openedDate: "Mar 2023" },
    ],
    overview: {
      contactNumber: "(628) 555-0213",
      assignedAgent: "Jeff Common",
      pronoun: "she",
      lastContactTime: "Today (inbound voice — 2nd transfer)",
      address: "520 Clay St, San Francisco, CA 94111",
    },
    interactionTimeline: [
      {
        id: "diana-call-start",
        title: "Inbound voice call — billing dispute",
        timestamp: "Today · 2:14 PM",
        detail: "Diana called to dispute a $147 charge posted March 14 for a Pro subscription she cancelled December 10. Has cancellation confirmation email.",
        tone: "warning" as const,
        sortOrder: 1,
      },
      {
        id: "diana-transfer-1",
        title: "Transferred to billing specialist",
        timestamp: "Today · 2:22 PM",
        detail: "Alex Rivera (Initial Agent) could not process refund — billing system returned ERR-4402. Escalated to billing specialist after 8 min.",
        tone: "default" as const,
        sortOrder: 2,
      },
      {
        id: "diana-transfer-2",
        title: "Transferred to billing supervisor",
        timestamp: "Today · 2:27 PM",
        detail: "Jamie Torres (Billing Specialist) confirmed cancellation on file but experienced system timeouts on both refund attempts. Escalating to supervisor with override authority.",
        tone: "default" as const,
        sortOrder: 3,
      },
    ],
    customerHistory: [
      {
        ...
        detail: "Customer cancelled Pro subscription via self-service portal. Cancellation confirmation email sent to diana.chen@email.com.",
        dot: "green" as const,
        type: "registration" as const,
      },
      {
        id: "diana-charge",
        title: "Unexpected charge — $147",
        timestamp: "Mar 14, 2026",
        detail: "$147 Pro subscription renewal posted despite active cancellation on record. Billing engine error likely caused the charge to process.",
        dot: "red" as const,
      },
    ],
    queue: {
      time: "0m",
      preview: "Billing dispute — $147 charge on cancelled subscription. 2nd transfer from prior agents.",
      priority: "High",
      priorityClassName: "border-[#E53935] bg-[#FDEAEA] text-[#C71D1A]",
      badgeColor: "#E32926",
      icon: "phone" as CustomerQueueIcon,
      isActive: false,
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    conversations: {
      chat: {
        label: "Voice",
        timelineLabel: "Voice call · Transfer history",
        draft: "",
        messages: [
          {
            id: 1,
            role: "customer" as const,
            content: "Hi, I'm calling about a charge on my account. I was billed $147 for a Pro subscription, but I cancelled that back in December. I have the confirmation email right here.",
            time: "Today, 2:14 PM",
          },
          {
            id: 2,
            role: "agent" as const,
            author: "Alex Rivera",
            content: "Hi Diana, I'm Alex. I can see the charge on your account — $147 posted March 14 for a Pro plan renewal. I can also see your cancellation on December 10, which is definitely on file. Let me get that refunded for you right now.",
            time: "Today, 2:15 PM",
          },
          {
            id: 3,
            role: "customer" as const,
            content: "Yes please, this is really frustrating. I cancelled months ago and shouldn't have been charged at all.",
            time: "Today, 2:15 PM",
          ...
          },
          {
            ...
            role: "agent" as const,
            author: "Alex Rivera",
            content: "Identity verified. Confirmed charge of $147 (March 14) against cancellation record dated December 10. Attempted $147 refund via standard flow — billing system returned ERR-4402 (engine timeout). Retried once, same error. Unable to process. Escalating to billing specialist for manual override.",
            time: "Today, 2:22 PM",
            isInternal: true,
          },
          {
            ...
            role: "agent" as const,
            author: "Jamie Torres",
            content: "Hi Diana, I'm Jamie, a billing specialist. I can confirm your December 10 cancellation is on record — you absolutely should not have been charged. I'm going to issue a manual credit override right now.",
            time: "Today, 2:23 PM",
          },
          {
            id: 6,
            role: "customer" as const,
            content: "Thank you. I've been on the phone for over 10 minutes now just trying to get a simple refund. This should have been sorted out immediately.",
            time: "Today, 2:24 PM",
            sentiment: "frustrated" as const,
          },
          {
            ...
            role: "agent" as const,
            author: "Jamie Torres",
            content: "Cancellation record confirmed on file (Dec 10, 2025 — within 30-day no-charge window). Manual credit override attempted twice — both requests timed out (ERR-4402). Billing engine appears to have an ongoing incident. Customer frustrated; has been on call 13+ minutes. Escalating to billing supervisor with system override authority.",
            time: "Today, 2:27 PM",
            isInternal: true,
          },
        ],
    ...
    customerSnapshot: [
      "3-year customer in good standing",
      "Cancelled Pro subscription December 10 — confirmation on file",
      "Charged $147 in error on March 14",
      "Frustrated after 13+ minutes on call with 2 prior transfers",
      "Expects immediate resolution with supervisor override authority",
    ],
  },
];
